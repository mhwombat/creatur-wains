...
energyFor (TestPattern p) a
  | p < 50   = if a == Walk then 0.1 else -0.1
  | p < 100   = if a == Run then 0.1 else -0.1
  | p < 150   = if a == Jump then 0.1 else -0.1
  | p < 200   = if a == Skip then 0.1 else -0.1
  | otherwise = if a == Crawl then 0.1 else -0.1
