...
examine a = do
  ...
  putStrLn $ "Classifier threshold: " ++ pretty (diffThreshold . view classifier . view brain $ a)
  ...
  putStrLn $ "Predictor threshold: " ++ pretty (diffThreshold . view predictor . view brain $ a)
