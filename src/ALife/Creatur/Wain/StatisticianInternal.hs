------------------------------------------------------------------------
-- |
-- Module      :  ALife.Creatur.Wain.StatisticianInternal
...
--
-- A module containing private Statistician internals.
-- Most developers should use Statistician instead.
...
module ALife.Creatur.Wain.StatisticianInternal where
