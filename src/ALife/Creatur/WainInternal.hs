...
instance (Serialize p, Serialize t, Serialize a, Eq a, Thinker t,
  p ~ Pattern t)
...
instance (Genetic p, Genetic t, Genetic a, Eq a,
  Serialize p, Serialize t, Serialize a, Thinker t, p ~ Pattern t)
...
incSwagger :: Wain p t a -> Wain p t a
